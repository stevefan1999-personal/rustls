...
trait SignatureAlgId {
    const SIG_ALGO_ID: alg_id::AlgorithmIdentifier;
}
...
impl SignatureAlgId for RsaPkcs1Verify<Sha512> {
    const SIG_ALGO_ID: alg_id::AlgorithmIdentifier = alg_id::RSA_PKCS1_SHA512;
}

impl SignatureAlgId for RsaPkcs1Verify<Sha384> {
    const SIG_ALGO_ID: alg_id::AlgorithmIdentifier = alg_id::RSA_PKCS1_SHA384;
}

impl SignatureAlgId for RsaPkcs1Verify<Sha256> {
    const SIG_ALGO_ID: alg_id::AlgorithmIdentifier = alg_id::RSA_PKCS1_SHA256;
}

impl SignatureAlgId for RsaPssVerify<Sha512> {
    const SIG_ALGO_ID: alg_id::AlgorithmIdentifier = alg_id::RSA_PSS_SHA512;
}

impl SignatureAlgId for RsaPssVerify<Sha384> {
    const SIG_ALGO_ID: alg_id::AlgorithmIdentifier = alg_id::RSA_PSS_SHA384;
}

impl SignatureAlgId for RsaPssVerify<Sha256> {
    const SIG_ALGO_ID: alg_id::AlgorithmIdentifier = alg_id::RSA_PSS_SHA256;
}
