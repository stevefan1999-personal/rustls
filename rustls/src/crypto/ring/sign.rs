...
use super::lib::io::der;
use super::lib::signature::{self, EcdsaKeyPair, Ed25519KeyPair, RsaKeyPair};
...
impl Signer for RsaSigner {
    fn sign(&self, message: &[u8]) -> Result<Vec<u8>, Error> {
        ...
        let rng = super::lib::rand::SystemRandom::new();
        self.key
